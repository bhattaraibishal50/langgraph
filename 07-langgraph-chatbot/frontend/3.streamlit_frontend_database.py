...
from backend.langgraph_2_database_backend import chatbot, retrieve_all_threads
...
if 'chat_threads' not in st.session_state:
    st.session_state['chat_threads'] = retrieve_all_threads() # get all threads from database
